...
<body>
	...
	<div id="kdpcontainer" style="float:right;display:none;">
		KDP:
		<object name="kdp" id="kdp" type="application/x-shockwave-flash" allowScriptAccess="always"
			allowNetworking="all" allowFullScreen="true" height="332" width="400"
	...
	<div>
		<form>
			<fieldset style="display:block;width:300px;margin:10px;padding: 1em;font:80%/1 sans-serif;">
				...
				<label
					style="float:left;width:45%;margin-right:0.5em;padding-top:0.2em;text-align:left;font-weight:bold;"
					for="quality" title="An integer that specifies the required level of picture quality,
...
(lowest quality, maximum compression) to 100 (highest quality, no compression)." />
				<label
					style="float:left;width:45%;margin-right:0.5em;padding-top:0.2em;text-align:left;font-weight:bold;"
					for="bandwidth" title="Specifies the maximum amount of bandwidth that the current outgoing video feed can use, in bytes per second. To specify that Flash Player video can use as much bandwidth as needed to
...
maintain the value of quality, pass 0 for bandwidth. The default value is 16384." />
	...
	Show debug info: <input id="showdebugCheck" type="checkbox" name="showdebugCheck"
		onchange="showDebugInfo();return false;" />
