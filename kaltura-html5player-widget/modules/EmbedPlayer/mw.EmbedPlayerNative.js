...
mw.EmbedPlayerNative = {
  ...
  doEmbedHTML: function () {
    ...
    mw.log(
      "EmbedPlayerNative:: play url:" +
        this.getSrc(this.currentTime) +
        " startOffset: " +
        this.start_ntp +
        " end: " +
        this.end_ntp
  ...
  getPlayerElementTime: function () {
    ...
    if (!this.playerElement) {
      mw.log(
        "mwEmbedPlayer::getPlayerElementTime: " +
          this.id +
          " not in dom ( stop monitor)"
      );
      return false;
    }
  ...
  switchPlaySrc: function (src, switchCallback, doneCallback) {
    var _this = this;
    mw.log(
      "EmbedPlayerNative:: switchPlaySrc:" +
        src +
        " native time: " +
        this.getPlayerElement().currentTime
    );
  ...
  onloadedmetadata: function () {
    ...
    if (this.playerElement && !isNaN(this.playerElement.duration)) {
      mw.log(
        "f:onloadedmetadata metadata ready Update duration:" +
          this.playerElement.duration +
          " old dur: " +
          this.getDuration()
      );
