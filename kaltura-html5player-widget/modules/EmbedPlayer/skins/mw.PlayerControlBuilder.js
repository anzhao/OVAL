...
(function (mw) {
  ...
  mw.PlayerControlBuilder.prototype = {
    ...
    addControlComponents: function () {
      ...
      mw.log(
        "PlayerControlsBuilder:: addControlComponents into:" +
    ...
    restoreWindowPlayer: function () {
      ...
      $interface.find(".play-btn-large").animate({
        left:
          (embedPlayer.getWidth() - this.getComponentWidth("playButtonLarge")) /
          2,
        top:
          (embedPlayer.getHeight() -
    ...
    doWarningBindinng: function (preferenceId, warningMsg) {
      mw.log(
        "controlBuilder: doWarningBindinng: " +
          preferenceId +
          " wm: " +
          warningMsg
      );
      ...
      $j(embedPlayer).hoverIntent({
        ...
        over: function () {
          ...
          if ($j("#warningOverlay_" + embedPlayer.id).length == 0) {
            ...
            $targetWarning.append(
              $j("<input />")
                ...
                .click(function () {
                  mw.log(
                    "WarningBindinng:: set " + preferenceId + " to hidewarning "
                  );
          ...
          if (
            ...
            mw.log(
              "WarningBindinng:: show warning " +
                mw.getConfig(preferenceId) +
                " cookie: " +
                $j.cookie(preferenceId) +
                "typeof:" +
                typeof $j.cookie(preferenceId)
            );
    ...
    displayMenuOverlay: function (overlayContent) {
      ...
      embedPlayer.$interface.append(
        $j("<div />").addClass("ui-widget-overlay").css({
          height: "100%",
          width: "100%",
          "z-index": 2,
        })
    ...
    getPlayerSelect: function () {
      mw.log(
        "ControlBuilder::getPlayerSelect: source:" +
              ...
              if (
                ...
                $playerLine = $j("<a />")
                  ...
                  .click(function () {
                    ...
                    mw.log(
                      "source id: " + sourceId + " player id: " + player_id
                    );
    ...
    components: {
      ...
      volumeControl: {
        ...
        o: function (ctrlObj) {
          mw.log(
            "PlayerControlBuilder::Set up volume control for: " +
