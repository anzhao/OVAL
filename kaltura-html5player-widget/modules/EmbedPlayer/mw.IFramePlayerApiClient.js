...
(function (mw) {
  ...
  mw.IFramePlayerApiClient.prototype = {
    ...
    hanldeReciveMsg: function (event) {
      ...
      if (
        typeof msgObject.triggerName != "undefined" &&
        msgObject.triggerArgs != "undefined"
      ) {
        //mw.log('IFramePlayerApiClient:: trigger: ' + msgObject.triggerName );
        $j(_this.playerProxy).trigger(
          msgObject.triggerName,
          msgObject.triggerArgs
        );
      }
    },
  ...
  (function ($) {
    $.fn.iFramePlayer = function (readyCallback) {
      ...
      $j(this.selector)
        ...
        .after($("<div />").attr("id", originalIframeId));
