...
mw.EmbedPlayerKplayer = {
  ...
  doSeek: function (percentage) {
    ...
    mw.log(
      "EmbedPlayerKalturaKplayer:: doSeek: " + percentage + " time:" + seekTime
    );
...
var swfobject = (function () {
    ...
    ua = (function () {
      var w3cdom =
        ...
        webkit = /webkit/.test(u)
          ...
          : false, // returns either the webkit version or false if
        // not webkit
  ...
  function callDomLoadFunctions() {
    ...
    try {
      // test if we can really add/remove elements to/from the DOM; we
        ...
        if (ua.pv[0] > 0) {
          ...
          if (obj) {
            if (
              ...
              // Flash Player and SWF version mismatch or
  ...
  function createSWF(attObj, parObj, id) {
    ...
    if (el) {
      ...
      if (ua.ie && ua.win) {
        // Internet Explorer + the HTML object
